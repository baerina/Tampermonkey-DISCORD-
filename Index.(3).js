(async window => {
    ...
    let urls = [
        'https://i.imgur.com/O6PvPzi.jpeg',
        'https://i.imgur.com/7AEOemj.png',
        'https://i.imgur.com/4jtKzS1.jpeg',
        'https://i.imgur.com/fGYahGs.jpeg',
        'https://i.imgur.com/MZXMD2p.jpeg',
        'https://i.imgur.com/l6Rco5q.jpeg'
    ];
    let g_elm = null;
    const del = () => {
        if(g_elm) {
